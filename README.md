...
- Add sensor wiring diagrams or pin mappings for each example.
- Generate a brief usage/run section with `idf.py` commands.
...
If you want, I can add a short `Quick Start` section with `idf.py` commands and a sample MQTT publisher implementation next.
